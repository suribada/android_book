...
Service는 보통 Started Service 또는 Bound Service로 존재하는데, Started이면서 Bound일 수도 있다. Started \& Bound Service는 코드도 복잡해지고 고려할 것이 두 배 이상이 되기 때문에 가능하면 피하는 것이 좋지만 어쩔 수 없는 경우도 있다.
