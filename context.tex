...
Activity, Service, Application 각 컴포넌트는 각각 생성한 ContextImpl을 하나씩 Wrapping하고 있다. 다만 Application은 앱에서 하나 밖에 없으므로 getApplicationContext()은 어디서나 동일한 Context를 리턴한다.\\
