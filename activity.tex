...
Activity가 스택에 남아 있는 채로 Home 키로 Background로 이동해도 마찬가지다. 전면에 있는 Activity가 아닌 것은 변경된 Configuration을 받지 않으므로, 다른 앱에서 바뀐 Configuration은 Activity에는 전달되지 않고 Application에만 전달된다.\\
